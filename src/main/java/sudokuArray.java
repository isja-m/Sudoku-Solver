...
public class sudokuArray {
    ...
    */
    ...
    public sudokuArray recursiveReduce(sudokuCell[][] recurseArray) {
        ...
        */
        ...
        if (!recursiveSudoku.isSolved()) {
            ...
            for (int number : cells[location[0]][location[1]].givePotentials()) {
                ...
                sudokuArray solvedSudoku = recursiveReduce(newCells);
    ...
    public sudokuArray recursiveReduce() {
    ...
    public ArrayList<int[]> giveNonReducedCells() {
        return nonReducedCells;
    }

    public ArrayList<int[]> giveNonReducedUnfilledCells() {
        return nonReducedUnfilledCells;
    }
}